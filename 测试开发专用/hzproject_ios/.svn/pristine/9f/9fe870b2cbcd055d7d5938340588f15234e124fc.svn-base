        ...
        // Group enumerator Block
            ...
            void (^assetGroupEnumberatorFailure)(NSError *) = ^(NSError *error) {
                ...
                if ([ALAssetsLibrary authorizationStatus] == ALAuthorizationStatusDenied) {
                    NSString *errorMessage = NSLocalizedString(@"请打开设置-隐私-照片，允许青岛日报访问", nil);
                    [[[UIAlertView alloc] initWithTitle:NSLocalizedString(@"警告", nil) message:errorMessage delegate:nil cancelButtonTitle:NSLocalizedString(@"Ok", nil) otherButtonTitles:nil] show];
...
- (void)reloadTableView
{
    ...
    [self.navigationController.navigationBar setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:Color(227, 50, 37), UITextAttributeTextColor,[UIFont systemFontOfSize:20], UITextAttributeFont,nil]];
}
